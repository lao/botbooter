...
// Microsoft Teams, GitHub, Signal and a local CLI.
//
...
// botbooter/github, botbooter/signal or botbooter/cli — each of which pulls in
// only its own platform SDK (WhatsApp Cloud API and Teams speak REST APIs over
// plain HTTP and need none; GitHub pulls google/go-github plus
// bradleyfalzon/ghinstallation for GitHub App auth; Signal speaks REST plus a
// receive WebSocket to a signal-cli-rest-api container and pulls only the
